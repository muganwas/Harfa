...
import {View, StatusBar, Text, StyleSheet, TextInput, Image, TouchableOpacity, Modal
    , Dimensions, ImageBackground, ActivityIndicator, Alert, Platform, BackHandler } from 'react-native';
    ...
    registerTask(imageObject) {
        ...
        firebaeMessaging.messaging().getToken().then((fcmToken) => {
            ...
            if (fcmToken) {
                ...
                userData.append("acc_type", this.state.accountType);
                userData.append('username', this.state.username);
                userData.append('email',this.state.email);
                userData.append('password', this.state.password)
                userData.append('mobile', this.state.mobile);
                userData.append('dob', this.state.dob);
                userData.append('image', { type: imageObject.type, uri: imageObject.uri, name: imageObject.fileName });
                userData.append('fcm_id',fcmToken),
                userData.append('type', "normal")
            ...
            <View style={styles.container}>
                ...
                <KeyboardAwareScrollView contentContainerStyle={{justifyContent: 'center', alignItems: 'center',
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <View style={{ width: screenWidth, height: screenWidth, backgroundColor: '#D8D7D3',
                            justifyContent: 'center', alignItems: 'center'}}>
                            <ImageBackground
                                style={{ width: screenWidth, height: screenWidth, }}
                                source={this.state.imageURI != null ? this.state.imageURI :
                                    require('../icons/user.png')} >

                                <View style={{width: screenWidth, height: screenWidth, }}> 
                                    <TouchableOpacity style={{ width: 35, height: 35, position: 'absolute', justifyContent: 'center', start:0, margin: 5, }}
                                        onPress={() => this.props.navigation.goBack()}>
                                        <Image style={{ width: 20, height: 20, alignSelf: 'center' }}
                                            source={require('../icons/arrow_back.png')} />
                                    </TouchableOpacity>

                                    <TouchableOpacity style={{width: 40, height: 40, position: 'absolute', end: 0, alignSelf: 'flex-end', 
                                        alignContent: 'center', justifyContent: 'center', borderRadius: 50, backgroundColor: '#fff',
                        ...
                        <View style={styles.logincontainer}>
                            ...
                            <View style={styles.textInputView}>
                                ...
                                <TextInput style={{ width: screenWidth - 85, height: 50, marginLeft: 5 }}
                                    ...
                                    onChangeText={(userNameInput) => this.setState({ error: '', username: userNameInput })}>
                                </TextInput>
                            </View>
                            ...
                            <View style={styles.textInputView}>
                                ...
                                <TextInput style={{ width: screenWidth - 85, height: 50, marginLeft: 5 }}
                                    placeholder='Email'
                                    onChangeText={(emailInput) => this.emailValidate(emailInput)}>
                                </TextInput>
                            </View>
                            ...
                            <TouchableOpacity style={styles.textInputView}
                                ...
                                <Text style={{ width: screenWidth - 85, color: 'black', fontSize: 14, textAlignVertical: 'center', alignSelf: 'center', marginLeft: 10 }}>
                                    {this.state.dob}
                                </Text>
                            </TouchableOpacity>
