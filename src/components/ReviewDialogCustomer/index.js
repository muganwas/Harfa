...
import { lightGray, black, colorBg, white, themeRed, colorGray, colorGreen } from '../../Constants/colors';
                ...
                <View style={[styles.modal, { width: this.state.width - 80 }]}>
                    <View style={styles.textView}>
                        ...
                        <Image style={{ width: 45, height: 45, borderRadius: 100, marginTop: 15 }}
                            source={ this.state.data.employee_details.image ? { uri: this.state.data.employee_details.image } : require('../../images/generic_avatar.png')}>
                        </Image>
                        <Text style={{ fontSize: 16, fontWeight: 'bold', marginTop: 10 }}>{this.state.data.employee_details.username + " " + this.state.data.employee_details.surname}</Text>
                        ...
                        <View>
                            <TextInput style={{
                                width: this.state.width - 120, height: 80, borderRadius: 5,
