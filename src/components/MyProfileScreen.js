...
import {View, StyleSheet, TouchableOpacity, Image, Dimensions, TextInput, Text, 
    ActivityIndicator, ToastAndroid, StatusBar, Platform, BackHandler, Animated} from 'react-native';
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={{flexDirection: 'row', width: '100%', height: 50, backgroundColor: colorPrimary,
                    paddingLeft: 10, paddingRight: 20, paddingBottom: 5,shadowColor: '#000',
            ...
            <KeyboardAwareScrollView contentContainerStyle={{flexGrow: 1, justifyContent: 'center', 
                ...
                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                    <View style={{ flex: 0.35, width: screenWidth, backgroundColor: colorYellow, 
                        ...
                        <Image 
                            style ={{width: 100, height: 100, borderRadius: 200, marginTop: 20}} 
                    ...
                    <View style={styles.logincontainer}>
                        ...
                        <View style={{
                            width: screenWidth - 50, height: 50, justifyContent: 'center', borderRadius: 5,
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'center', alignContent: 'center', marginTop: 10, marginBottom: 10 }}>
                                ...
                                <View style={styles.buttonGreen}>
                                    <Text style={styles.text}>{UserDetails.User.accountType}</Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={styles.textInputView}>
                            ...
                            <Text style={{width: screenWidth-85,  marginLeft: 10, textAlignVertical: 'center' }}>
                                {this.state.email}
                            </Text>
                        </View>
